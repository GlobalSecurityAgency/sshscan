...
def parse_ciphers(data,verbose):
    ...
    weak_ciphers = ('3des-cbc', 'aes128-cbc', 'aes192-cbc', 'aes256-cbc', 'blowfish-cbc', 'cast128-cbc', 'rijndael-cbc@lysator.liu.se', 'arcfour', 'arcfour128', 'arcfour256' )
...
def parse_macs(data,verbose):
    ...
    weak_macs = ('hmac-md5', 'hmac-md5-96', 'hmac-sha1', 'hmac-sha1-96', 'arcfour', 'arcfour128', 'arcfour256' ,'umac-64-etm@openssh.com', 'umac-128-etm@openssh.com', 'arcfour', 'arcfour128', 'arcfour256' )
...
def parse_kex(data,verbose):
    ...
    weak_kex = ('diffie-hellman-group1-sha1', 'diffie-hellman-group-exchange-sha1', 'diffie-hellman-group14-sha1','gss-gex-sha1-','gss-group1-sha1','rsa1024-sha1')
    #weak_kex = ()
